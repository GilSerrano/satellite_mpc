...
yref(1:3) = pee_final;
yref(4:6) = [r11_final, r21_final, r31_final];
yref(7:9) = [r12_final, r22_final, r32_final];
yref(10:12) = [r13_final, r23_final, r33_final];
yref_e(1:3) = pee_final;
yref_e(4:6) = [r11_final, r21_final, r31_final];
yref_e(7:9) = [r12_final, r22_final, r32_final];
yref_e(10:12) = [r13_final, r23_final, r33_final];
%% discretization
